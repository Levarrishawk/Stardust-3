...
blackEpsilonMission("escort_corellia_imperial_tier4_3", SpaceEscortScreenplay, chain({questName = "corellia_imperial_tier4_3", questType = "escort", questZone = dathomir, creditReward = 10000, escortSpeed = 45, orderedEscortRoute = true, escortShips = {"imp_lambda_shuttle_tier4"}, escortPoints = {{patrolPointName = "black_epsilon_t4_3_escort_1", zoneName = dathomir, x = -5100, z = 1800, y = -3900, escortNumber = 1, radius = 250}, {patrolPointName = "black_epsilon_t4_3_escort_2", zoneName = dathomir, x = -1700, z = 900, y = -900, escortNumber = 2, radius = 250}, {patrolPointName = "black_epsilon_t4_3_escort_3", zoneName = dathomir, x = 2600, z = -300, y = 2600, escortNumber = 3, radius = 250}}, attackDelay = 20, attackShips = {{"velocity_merc_med_fighter_tier4", "velocity_merc_med_fighter_tier4"}, {"velocity_merc_light_fighter_tier4", "velocity_merc_light_fighter_tier4"}}}, "rescue", "corellia_imperial_tier4_3_a"))
