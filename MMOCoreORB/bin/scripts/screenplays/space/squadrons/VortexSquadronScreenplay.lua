...
recovery_naboo_rebel_tier3_1 = SpaceRecoveryScreenplay:new {
	...
	preRecoveryPoints = {
		{patrolPointName = "vortex_spy_flight_path_2", zoneName = "space_yavin4", x = 4793, z = -5425, y = 4509, escortNumber = 1, radius = 250},
		{patrolPointName = "vortex_spy_flight_path_3", zoneName = "space_yavin4", x = 4358, z = -4600, y = 4097, escortNumber = 2, radius = 250},
		{patrolPointName = "vortex_spy_flight_path_4", zoneName = "space_yavin4", x = 4040, z = -3996, y = 3796, escortNumber = 3, radius = 250},
		{patrolPointName = "vortex_spy_flight_path_5", zoneName = "space_yavin4", x = 3589, z = -3140, y = 3370, escortNumber = 4, radius = 250},
		{patrolPointName = "vortex_spy_flight_path_6", zoneName = "space_yavin4", x = 3280, z = -2554, y = 3078, escortNumber = 5, radius = 250},
		{patrolPointName = "vortex_spy_flight_path_7", zoneName = "space_yavin4", x = 2073, z = -2087, y = 2117, escortNumber = 6, radius = 250},
		{patrolPointName = "vortex_spy_flight_path_1", zoneName = "space_yavin4", x = 5199, z = -6199, y = 4893, escortNumber = 7, radius = 250},
	},

	recoveryPoints = {
		{patrolPointName = "vortex_spy_recovery_path_1", zoneName = "space_yavin4", x = 3463, z = -2741, y = 2867, escortNumber = 1, radius = 250},
		{patrolPointName = "vortex_spy_recovery_path_2", zoneName = "space_yavin4", x = 3367, z = -2354, y = 2296, escortNumber = 2, radius = 250},
		{patrolPointName = "vortex_spy_recovery_path_3", zoneName = "space_yavin4", x = 3282, z = -2008, y = 1786, escortNumber = 3, radius = 250},
		{patrolPointName = "vortex_spy_recovery_path_4", zoneName = "space_yavin4", x = 3143, z = -1446, y = 956, escortNumber = 4, radius = 250},
	},
...
patrol_naboo_rebel_tier3_1_A = SpacePatrolScreenplay:new {
	...
	patrolPoints = {
		{patrolPointName = "vortex_rebel_tier_three_patrol_1", x = 2793, z = -276, y = -1231, patrolNumber = 1, radius = 150},
		{patrolPointName = "vortex_rebel_tier_three_patrol_2", x = 3215, z = -695, y = -1854, patrolNumber = 2, radius = 150},
		{patrolPointName = "vortex_rebel_tier_three_patrol_3", x = 3680, z = -853, y = -2726, patrolNumber = 3, radius = 150},
		{patrolPointName = "vortex_rebel_tier_three_patrol_4", x = 3975, z = -1404, y = -3805, patrolNumber = 4, radius = 150},
	},
}
...
assassinate_naboo_rebel_tier3_1_c = SpaceAssassinateScreenplay:new {
	...
	targetPatrols = {
		{patrolPointName = "vortex_imperial_scout_flight_path_1", zoneName = "space_yavin4", x = 3593, z = -1050, y = -3060},
		{patrolPointName = "vortex_imperial_scout_flight_path_2", zoneName = "space_yavin4", x = 3255, z = -758, y = -2450},
		{patrolPointName = "vortex_imperial_scout_flight_path_3", zoneName = "space_yavin4", x = 2804, z = -215, y = -1382},
		{patrolPointName = "vortex_imperial_scout_flight_path_4", zoneName = "space_yavin4", x = 2290, z = 302, y = -266},
	},
}
...
escort_naboo_rebel_tier3_2_c = SpaceEscortScreenplay:new {
	...
	escortPoints = {
		{patrolPointName = "vortex_rebel_tier3_2_c_escort_1", zoneName = "space_endor", x = -239, z = 3935, y = 3280, escortNumber = 1, radius = 250},
		{patrolPointName = "vortex_rebel_tier3_2_c_escort_2", zoneName = "space_endor", x = -549, z = 3180, y = 3238, escortNumber = 2, radius = 250},
		{patrolPointName = "vortex_rebel_tier3_2_c_escort_3", zoneName = "space_endor", x = -1251, z = 1477, y = 3143, escortNumber = 3, radius = 250},
		{patrolPointName = "vortex_rebel_tier3_2_c_escort_4", zoneName = "space_endor", x = -1996, z = -330, y = 3042, escortNumber = 4, radius = 250},
	},
...
VortexSquadronScreenplay = ScreenPlay:new {
	...
	TIER3_QUEST_STRING_1_SIDE1 = {type = "patrol", name = "naboo_rebel_tier3_1_A"},
	...
	TIER3_QUEST_STRING_2_SIDE1 = {type = "delivery", name = "naboo_rebel_tier3_2_a"},
