...
MeatlumpHideoutScreenPlay = ScreenPlay:new {
	...
	npcMap = {
		...
		["mtp_meatlump_vendor"] = "mtp_meatlump_vendor", -- scenery only; vendor stock is separate
		...
		["mtp_hideout_col_eavesdrop_npc_01"] = "mtp_hideout_col_eavesdrop_npc_01", -- creatures.tab:6108
