...
-- Meatlump hideout (part 1)
includeFile("events/meatlumpLadderDownMenuComponent.lua")
includeFile("events/meatlumpLadderUpMenuComponent.lua")
includeFile("poi/corellia_meatlump_hideout.lua")
