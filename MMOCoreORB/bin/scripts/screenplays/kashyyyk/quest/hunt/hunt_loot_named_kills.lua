...
huntLootNamedKillsScreenPlay = ScreenPlay:new {
	...
	rows = {
	{ quest = "ep3_hunt_loot_silkthrower_killed", sp = huntLootSilkthrowerKilledScreenPlay, signal = "lootQuest_defeatedSilkthrower", item = "object/tangible/quest/quest_start/ep3_hunt_loot_silkthrower_fang.iff", templates = { "webweaver" } },
	{ quest = "ep3_hunt_loot_stoneleg_killed", sp = huntLootStonelegKilledScreenPlay, signal = "lootQuest_defeatedStoneleg", item = "object/tangible/quest/quest_start/ep3_hunt_loot_stoneleg_heart.iff", templates = { "walluga" } },
	{ quest = "ep3_hunt_loot_spiketop_killed", sp = huntLootSpiketopKilledScreenPlay, signal = "lootQuest_defeatedSpiketop", item = "object/tangible/quest/quest_start/ep3_hunt_loot_spiketop_horn.iff", templates = { "uller_stoneclaw" } },
	{ quest = "ep3_hunt_loot_greyclimber_killed", sp = huntLootGreyclimberKilledScreenPlay, signal = "lootQuest_defeatedGreyclimber", item = "object/tangible/quest/quest_start/ep3_hunt_loot_greyclimber_eye.iff", templates = { "kashyyyk_bull_bantha" } },
