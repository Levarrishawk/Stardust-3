...
mtpMapQuestDathomir01ScreenPlay = ScreenPlay:new {
	...
	repeatable = false,
	rewardCredits = 0, -- SOURCED questlist/quest/mtp_map_quest_dathomir_01.tab QUEST_REWARD_BANK_CREDITS=0 QUEST_REWARD_EXPERIENCE_AMOUNT=0
	rewardXp = 0, -- SOURCED questlist/quest/mtp_map_quest_dathomir_01.tab QUEST_REWARD_BANK_CREDITS=0 QUEST_REWARD_EXPERIENCE_AMOUNT=0
