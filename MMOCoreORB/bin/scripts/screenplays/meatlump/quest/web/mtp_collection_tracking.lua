...
mtpCollectionTrackingScreenPlay = ScreenPlay:new {
	...
	repeatable = false,
	rewardCredits = 0, -- SOURCED questlist/quest/mtp_collection_tracking.tab QUEST_REWARD_BANK_CREDITS=0 QUEST_REWARD_EXPERIENCE_AMOUNT=2000
	rewardXp = 2000, -- SOURCED questlist/quest/mtp_collection_tracking.tab QUEST_REWARD_BANK_CREDITS=0 QUEST_REWARD_EXPERIENCE_AMOUNT=2000
