...
mtpFindInfiltrator4ScreenPlay = ScreenPlay:new {
	...
	repeatable = false,
	rewardCredits = 0, -- SOURCED questlist/quest/mtp_find_infiltrator_4.tab QUEST_REWARD_BANK_CREDITS=0 QUEST_REWARD_EXPERIENCE_AMOUNT=2500
	rewardXp = 2500, -- SOURCED questlist/quest/mtp_find_infiltrator_4.tab QUEST_REWARD_BANK_CREDITS=0 QUEST_REWARD_EXPERIENCE_AMOUNT=2500
