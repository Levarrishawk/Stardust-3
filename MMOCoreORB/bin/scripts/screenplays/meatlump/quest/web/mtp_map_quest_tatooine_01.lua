...
mtpMapQuestTatooine01ScreenPlay = ScreenPlay:new {
	...
	repeatable = false,
	rewardCredits = 0, -- SOURCED questlist/quest/mtp_map_quest_tatooine_01.tab QUEST_REWARD_BANK_CREDITS=0 QUEST_REWARD_EXPERIENCE_AMOUNT=1000
	rewardXp = 1000, -- SOURCED questlist/quest/mtp_map_quest_tatooine_01.tab QUEST_REWARD_BANK_CREDITS=0 QUEST_REWARD_EXPERIENCE_AMOUNT=1000
