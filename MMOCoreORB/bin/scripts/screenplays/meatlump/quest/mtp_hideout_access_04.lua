--[[
	...
	item_meatlump_lump_01_01 x9 is OPEN (token currency not in the fork). Credits are the questlist NGE amounts (REWARD_CREDITS on task rows is 0). Rebalance pending.
]]
...
mtpHideoutAccess04ScreenPlay = ScreenPlay:new {
	...
	repeatable = false,
	rewardCredits = 6412, -- OPEN: shipped NGE amount; the rebalance is a maintainer ruling
