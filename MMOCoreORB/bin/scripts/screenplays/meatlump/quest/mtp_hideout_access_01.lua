...
mtpHideoutAccess01ScreenPlay = ScreenPlay:new {
	...
	repeatable = false,
	rewardCredits = 6492, -- SOURCED questlist/quest/mtp_hideout_access_01.tab QUEST_REWARD_BANK_CREDITS=6492 QUEST_REWARD_EXPERIENCE_AMOUNT=0
	rewardXp = 0, -- SOURCED questlist/quest/mtp_hideout_access_01.tab QUEST_REWARD_BANK_CREDITS=6492 QUEST_REWARD_EXPERIENCE_AMOUNT=0
