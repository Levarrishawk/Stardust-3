--[[
	mtp hideout access 06  --  mtp_hideout_access_06

	ruling 2026-09-04

	SOURCE: leaked questlist/questtask for quest/mtp_hideout_access_06. Client ships the
...
mtpHideoutAccess06ScreenPlay = ScreenPlay:new {
	...
	tasks = {
		...
		},
		{
			...
			onComplete = { 2 },
			visible = true,
			title = "@quest/ground/mtp_hideout_access_06:task01_journal_entry_title",
			description = "@quest/ground/mtp_hideout_access_06:task01_journal_entry_description",
			watches = { "mtp_hideout_access_06_01a", "mtp_hideout_access_06_01b" },
			planet = "corellia",
			x = -1761.0,
			y = 0,
			z = -3268.0,
			waypointName = "@quest/ground/mtp_hideout_access_06:task01_waypoint_name",
		},
		{
			id = 2,
			...
			onComplete = {  },
			visible = true,
			title = "@quest/ground/mtp_hideout_access_06:task02_journal_entry_title",
			description = "@quest/ground/mtp_hideout_access_06:task02_journal_entry_description",
			signal = "mtp_hideout_access_06_02",
			planet = "corellia",
			x = -277.0,
			y = 28.0,
			z = -4144.0,
			waypointName = "@quest/ground/mtp_hideout_access_06:task02_waypoint_name",
		},
		{
			id = 3,
			...
			onComplete = {  },
			visible = true,
			title = "@quest/ground/mtp_hideout_access_06:task03_journal_entry_title",
			description = "@quest/ground/mtp_hideout_access_06:task03_journal_entry_description",
			count = 1,
			target = "mtp_quest_rogue_corsec_02",
		...
		},
		{
			...
			onComplete = {  },
			visible = true,
			title = "@quest/ground/mtp_hideout_access_06:task04_journal_entry_title",
			description = "@quest/ground/mtp_hideout_access_06:task04_journal_entry_description",
			count = 1,
			target = "mtp_quest_rogue_corsec_01",
...
MtpQuestEngine.install(mtpHideoutAccess06ScreenPlay)
