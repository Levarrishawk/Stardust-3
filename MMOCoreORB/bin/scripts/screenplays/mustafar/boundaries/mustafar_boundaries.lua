...
function mustafar_boundaries:start()
  if (isZoneEnabled("mustafar")) then
      ...
      -- We12 through We32 are fully defined below but start() stopped calling at We11, so 21
      -- areas never spawned and the west wall was open from there south.
      self:spawnActiveAreaWe12()
      self:spawnActiveAreaWe13()
      self:spawnActiveAreaWe14()
      self:spawnActiveAreaWe15()
      self:spawnActiveAreaWe16()
      self:spawnActiveAreaWe17()
      self:spawnActiveAreaWe18()
      self:spawnActiveAreaWe19()
      self:spawnActiveAreaWe20()
      self:spawnActiveAreaWe21()
      self:spawnActiveAreaWe22()
      self:spawnActiveAreaWe23()
      self:spawnActiveAreaWe24()
      self:spawnActiveAreaWe25()
      self:spawnActiveAreaWe26()
      self:spawnActiveAreaWe27()
      self:spawnActiveAreaWe28()
      self:spawnActiveAreaWe29()
      self:spawnActiveAreaWe30()
      self:spawnActiveAreaWe31()
      self:spawnActiveAreaWe32()
      -- north
...
-- Ea21, Ea22 and Ea23 each createObserver on "notifySpawnAreaEa9", which was never written, so
-- entering any of those three areas hit a missing handler and the wall did nothing there. The
-- teleport target is Ea8's, the nearest point on this stretch the author already validated as
-- standing ground -- interpolating an inland point for z~774 would mean guessing a terrain height.
