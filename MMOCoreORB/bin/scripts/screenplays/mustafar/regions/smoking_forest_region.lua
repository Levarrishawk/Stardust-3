...
-- Canyon Approach Phantom Bandits near Escape Pod
  ...
  -- Both moods were set on pPhantom1, a name that exists only in storm_lord_region.lua and is
  -- nil here, so setMoodString short-circuited and these two kept their default mood.
  local pMinerHens = spawnMobile("mustafar", "miner_hens",120,-5406.1,296.0,4429.8,29,0)
  self:setMoodString(pMinerHens, "neutral")
  local pForemanNurfa = spawnMobile("mustafar", "foreman_nurfa",120,-5396.5,296.0,4447.8,-163,0)
  self:setMoodString(pForemanNurfa, "neutral")
  ...
  local pStrikingMiner6 = spawnMobile("mustafar", "miner_on_strike",120,-5384.6,294,4451.2,-163,0)
  self:setMoodString(pStrikingMiner6, "idlewander")
  -- Miners 6 and 7 used to share miner 1's point; these two were moved off it along
  -- the same picket line. The coordinates are ours -- no live table covers this outdoor camp.
  local pStrikingMiner7 = spawnMobile("mustafar", "miner_foreman_on_strike",120,-5369.4,294,4432.5,-163,0)
  ...
  local pStrikingMiner10 = spawnMobile("mustafar", "miner_on_strike",120,-5276,316,4486,-163,0)
  self:setMoodString(pStrikingMiner10, "idlewander")
...
-- Blackguard Ruins
  ...
  local pTreasure19 = spawnMobile("mustafar", "treasure_hunter_merc",120,-4247.2,83.3,3360.6,122,0)
  self:setMoodString(pTreasure19, "neutral") 
