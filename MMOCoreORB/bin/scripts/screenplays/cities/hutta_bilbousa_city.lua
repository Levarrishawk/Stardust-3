...
function BilbousaCityScreenPlay:spawnMobiles()
  ...
  local pNpc = spawnMobile("hutta", "slicer", 60, -923.1, 80, 1600.7, 153, 0)
   ...
   -- Bilbousa City / Guards
    --Starport Plaza
    spawnMobile("hutta", "hutt_enforcer", 60, -773, 80, 1709, 132, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -759, 80, 1709, -152, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -806, 80, 1693, 80, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -760, 80, 1681, -93, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -771, 80, 1681, 78, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -707.9, 80, 1706, -93, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -712.7, 80, 1630.4, -59, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -710.3, 80, 1602, -135, 0)
    
    --Bank
    spawnMobile("hutta", "hutt_enforcer", 60, -786, 80.5, 1581, -46, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -747, 80.5, 1581, 49, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -746, 80.5, 1542, 132, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -786, 80, 1542, -132, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -779, 80, 1561, -90, 0)
    
    --Palace front
    spawnMobile("hutta", "hutt_enforcer", 60, -776, 80, 1415, 0, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -758, 80, 1415, 0, 0)
    
    -- Great Bazaar
    spawnMobile("hutta", "hutt_enforcer", 60, -756, 80, 1453, -90, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -776, 80, 1453, 90, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -767, 80, 1612, -180, 0)
    
    --Bounty Hunter's Guild
    spawnMobile("hutta", "hutt_enforcer", 60, -855, 80, 1548, 0, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -891, 80, 1532, -44, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -890, 80, 1592, -144, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -937.4, 81.2, 1570, 78, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -937.4, 81.2, 1554, 96, 0)
    
    --Garage Area
    spawnMobile("hutta", "hutt_enforcer", 60, -852, 80, 1446, -139, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -926.5, 80, 1459.9, 141, 0)
    
    --Hotel Area
    spawnMobile("hutta", "hutt_enforcer", 60, -849.4, 80, 1651.3, 50, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -836.9, 80, 1664.4, -132, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -868, 81, 1682.9, 132, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -865.5, 81, 1685, 132, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -900.8, 80, 1631.1, 0, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -970, 80, 1638.6, 82, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -985.1, 80, 1698.8, 179, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -959.2, 80, 1783, 178, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -862.6, 80, 1784.8, 121, 0)
    
    --Cantina / Cloner Area
    spawnMobile("hutta", "hutt_enforcer", 60, -691.3, 80, 1577.2, -54, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -691.2, 80, 1538.2, -9, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -612.9, 80, 1544.89, 131, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -592, 80, 1588.9, 88, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -575.3, 80, 1514.8, -93, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -630.6, 80, 1474.9, -90, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -630.6, 80, 1451.4, -90, 0)
    spawnMobile("hutta", "hutt_enforcer", 60, -685.1, 80, 1439.2, -180, 0)
  ...
  -- Bounty Hunter's Guild Interior
    ...
    spawnMobile("hutta", "hutt_enforcer", 60, 9.1, 8.1, -34.4, -57, 390000049)
    spawnMobile("hutta", "hutt_enforcer", 60, -9.1, 8.1, -34.4, 13, 390000049)
    
    spawnMobile("hutta", "hutt_enforcer", 60, -5.4, 4.1, 17.7, 180, 390000049)
    spawnMobile("hutta", "hutt_enforcer", 60, 5.4, 4.1, 17.7, 180, 390000049)
    ...
    spawnMobile("hutta", "hutt_enforcer",400,-586,80,1644,-89,0)
    spawnMobile("hutta", "hutt_enforcer",400,-614,80,1679,89,0)
    spawnMobile("hutta", "hutt_enforcer",400,-570,80,1710,180,0)  
    spawnMobile("hutta", "hutt_enforcer",400,-515,80,1736,-52,0)
    spawnMobile("hutta", "hutt_enforcer",400,-532.7,80,1789,180,0)
    spawnMobile("hutta", "hutt_enforcer",400,-581.7,80,1789,175,0)
    spawnMobile("hutta", "hutt_enforcer",400,-606,80,1789,166,0)
    ...
    spawnMobile("hutta", "hutt_enforcer",400,-767.2,80,1528,175,0)
    ...
    pNpc = spawnMobile("hutta", "hutt_compound_guard",60,-774.9,80,1493,-152,0)
    self:setMoodString(pNpc, "neutral")
    
    pNpc = spawnMobile("hutta", "hutt_compound_guard",60,-756.4,80,1493,130,0)
    self:setMoodString(pNpc, "neutral")
    
    pNpc = spawnMobile("hutta", "hutt_compound_guard",60,-774.9,80,1512,-45,0)
    self:setMoodString(pNpc, "neutral")
