-- object/tangible/terminal/terminal_echo_base_entrance_rebel.lua
...
object_tangible_terminal_terminal_echo_base_entrance_rebel =
    object_tangible_quest_township_shared_star_destroyer_intro_security_console:new {
	customName = "an Echo Base Rebel Launch Console",     -- OURS, NOT SOURCED
	objectMenuComponent = "echoBaseEntryMenuComponent",
}

ObjectTemplates:addTemplate(object_tangible_terminal_terminal_echo_base_entrance_rebel,
    "object/tangible/terminal/terminal_echo_base_entrance_rebel.iff")
