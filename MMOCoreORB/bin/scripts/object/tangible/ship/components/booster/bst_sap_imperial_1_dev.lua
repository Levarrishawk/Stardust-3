...
ObjectTemplates:addTemplate(object_tangible_ship_components_booster_bst_sap_imperial_1_dev, "object/tangible/ship/components/booster/bst_sap_imperial_1_dev.iff")
