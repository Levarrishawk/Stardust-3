...
ObjectTemplates:addTemplate(object_tangible_ship_components_armor_arm_prototype_armor_dev, "object/tangible/ship/components/armor/arm_prototype_armor_dev.iff")
