...
ObjectTemplates:addTemplate(object_tangible_ship_components_weapon_wpn_tiefighter_basic_dev, "object/tangible/ship/components/weapon/wpn_tiefighter_basic_dev.iff")
