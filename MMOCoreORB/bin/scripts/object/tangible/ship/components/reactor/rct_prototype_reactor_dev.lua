...
object_tangible_ship_components_reactor_rct_prototype_reactor_dev = object_tangible_ship_components_reactor_shared_rct_prototype_reactor_dev:new {
	...
	attributes = {
		...
		{"maximumHitpoints", 1350},
		{"maximumArmorHitpoints", 670.5},
		{"mass", 10},
...
ObjectTemplates:addTemplate(object_tangible_ship_components_reactor_rct_prototype_reactor_dev, "object/tangible/ship/components/reactor/rct_prototype_reactor_dev.iff")
