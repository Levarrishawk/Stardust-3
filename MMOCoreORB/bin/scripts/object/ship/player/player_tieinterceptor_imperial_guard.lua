...
-- The "Crimson Guard" TIE Interceptor handed over by recovery/ep3_red_tie_recovery.
-- Body copied verbatim from player_tieinterceptor.lua -- station_imperial_base.stf s_356/s_266
-- describe it only as a "'Crimson Guard' TIE Interceptor", i.e. a livery, and name no stat that
-- differs from the standard Interceptor, so nothing is changed.
object_ship_player_player_tieinterceptor_imperial_guard = object_ship_player_shared_player_tieinterceptor_imperial_guard:new {
	...
	-- client's datatables/space/ship_chassis.iff has no "player_tieinterceptor_imperial_guard" row,
	-- so this hull borrows the shipped "player_tieinterceptor" row -- the same mechanism
	-- player_yt1300_decorated_01.lua uses to borrow "player_yt1300".
