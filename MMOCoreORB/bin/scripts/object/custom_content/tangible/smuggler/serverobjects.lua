...
includeFile("custom_content/tangible/smuggler/finely_crafted_toolset.lua")
includeFile("custom_content/tangible/smuggler/illegal_core_booster.lua")
includeFile("custom_content/tangible/smuggler/illegal_weapon_module.lua")
includeFile("custom_content/tangible/smuggler/mandalorian_interframe.lua")
includeFile("custom_content/tangible/smuggler/powered_motivators.lua")
