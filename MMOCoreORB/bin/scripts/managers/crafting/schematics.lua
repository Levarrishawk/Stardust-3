...
--  {path="object/draft_schematic/structure/vipbunker_house_schem.iff"},
 ...
 ------------------------------------------------------------------
  ...
  ------------------------------------------------------------------
  {path="object/draft_schematic/clothing/clothing_collection_jeweled_necklace.iff"},
  {path="object/draft_schematic/dance_prop/prop_combat_fan_l.iff"},
  {path="object/draft_schematic/droid/component/droid_dance_module.iff"},
  {path="object/draft_schematic/furniture/furniture_collection_dejarik_table.iff"},
  {path="object/draft_schematic/furniture/furniture_collection_fish_tank.iff"},
  {path="object/draft_schematic/furniture/furniture_collection_glass_shelves_01.iff"},
  {path="object/draft_schematic/furniture/furniture_collection_hanging_light_01.iff"},
  {path="object/draft_schematic/furniture/furniture_collection_hanging_light_02.iff"},
  {path="object/draft_schematic/furniture/furniture_collection_pob_chair.iff"},
  {path="object/draft_schematic/furniture/furniture_collection_pob_couch.iff"},
  {path="object/draft_schematic/furniture/furniture_flowers_collection_potted_s01.iff"},
  {path="object/draft_schematic/furniture/furniture_framed_beetle_specimen_collection_reward.iff"},
  {path="object/draft_schematic/furniture/furniture_light_gem_green.iff"},
  {path="object/draft_schematic/furniture/furniture_light_gem_purple.iff"},
  {path="object/draft_schematic/furniture/furniture_light_gem_red.iff"},
  {path="object/draft_schematic/furniture/furniture_plants_collection_potted_large_s01.iff"},
  {path="object/draft_schematic/furniture/furniture_stage_backdrop.iff"},
  {path="object/draft_schematic/furniture/furniture_stage_controller.iff"},
  {path="object/draft_schematic/furniture/furniture_stage_pyro.iff"},
  {path="object/draft_schematic/furniture/furniture_stage_smoke.iff"},
  {path="object/draft_schematic/furniture/furniture_throwpillow_hue_s01.iff"},
  {path="object/draft_schematic/item/collection_dwartii_statue_braata.iff"},
  {path="object/draft_schematic/item/collection_dwartii_statue_faya.iff"},
  {path="object/draft_schematic/item/collection_dwartii_statue_sistros.iff"},
  {path="object/draft_schematic/item/collection_dwartii_statue_yanjon.iff"},
  {path="object/draft_schematic/item/collection_ice_cream_fryer.iff"},
  {path="object/draft_schematic/item/collection_posed_ig_88.iff"},
  {path="object/draft_schematic/item/collection_posed_stormtrooper.iff"},
