...
function SpaceHelpers:addAqzowWaypoint(pPlayer)
	...
	local pGhost = CreatureObject(pPlayer):getPlayerObject()
	if (pGhost ~= nil) then
		PlayerObject(pGhost):addWaypoint("yavin4", "@npc_spawner_n:aqzow", "@npc_spawner_n:aqzow", -3078, 0, -2998, WAYPOINT_BLUE, true, true, 0)
	end
end
...
function SpaceHelpers:addCrimsonPhoenixNextWaypoint(pPlayer)
	...
	local pGhost = CreatureObject(pPlayer):getPlayerObject()
	if (pGhost ~= nil) then
		PlayerObject(pGhost):addWaypoint("yavin4", "@npc_spawner_n:eker", "@npc_spawner_n:eker", -3078, 0, -2998, WAYPOINT_BLUE, true, true, 0)
	end
end
