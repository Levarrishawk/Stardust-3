-- Transcribes datatables/loot/loot_types/kashyyyk/sayormi_witch.tab
-- strItems lists: kashyyyk/sayormi_witch
...
sayormi_witch = {
	...
	lootItems = {
		...
		{itemTemplate = "ep3_loot_blackbane", weight = 416666},
	}
}

addLootGroupTemplate("sayormi_witch", sayormi_witch)
