-- Transcribes datatables/loot/loot_types/kashyyyk/sayormi_cyrans.tab
-- strItems lists: kashyyyk/sayormi_cyrans
...
sayormi_cyrans = {
	...
	lootItems = {
		...
		{itemTemplate = "ep3_loot_sickle", weight = 400000},
		{itemTemplate = "ep3_loot_quicktrigger", weight = 400000},
	}
}

addLootGroupTemplate("sayormi_cyrans", sayormi_cyrans)
