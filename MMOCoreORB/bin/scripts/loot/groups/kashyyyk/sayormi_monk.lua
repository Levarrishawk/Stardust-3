-- Transcribes datatables/loot/loot_types/kashyyyk/sayormi_monk.tab
-- strItems lists: kashyyyk/sayormi_monk
...
sayormi_monk = {
	...
	lootItems = {
		...
		{itemTemplate = "ep3_loot_heartstriker", weight = 416666},
	}
}

addLootGroupTemplate("sayormi_monk", sayormi_monk)
