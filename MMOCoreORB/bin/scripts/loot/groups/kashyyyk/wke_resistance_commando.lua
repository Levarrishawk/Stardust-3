-- Transcribes datatables/loot/loot_types/kashyyyk/wke_resistance_commando.tab
...
addLootGroupTemplate("wke_resistance_commando", wke_resistance_commando)
