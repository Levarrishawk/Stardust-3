house_thul_camp_neutral_medium_theater = Lair:new {
	mobiles = {{"house_thul_thug",2},{"house_thul_pirate",2},{"house_thul_mercenary",1},{"house_thul_taskmaster",1}},
	spawnLimit = 15,
...
addLairTemplate("house_thul_camp_neutral_medium_theater", house_thul_camp_neutral_medium_theater)
