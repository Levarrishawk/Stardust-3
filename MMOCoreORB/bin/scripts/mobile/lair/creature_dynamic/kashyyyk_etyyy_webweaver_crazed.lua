...
--   ep3_etyyy_webweaver_crazed -> webweaver  size=5  iff-matched (repo templates iff equals SOE template column webweaver.iff; creatures.tab line 1329; level-4 placeholder today, the level curve is an open ruling)
--   ep3_etyyy_webweaver_crazed -> webweaver  size=5  iff-matched (repo templates iff equals SOE template column webweaver.iff; creatures.tab line 1329; level-4 placeholder today, the level curve is an open ruling)
--   ep3_etyyy_webweaver_crazed -> webweaver  size=5  iff-matched (repo templates iff equals SOE template column webweaver.iff; creatures.tab line 1329; level-4 placeholder today, the level curve is an open ruling)
--   ep3_etyyy_webweaver_crazed -> webweaver  size=5  iff-matched (repo templates iff equals SOE template column webweaver.iff; creatures.tab line 1329; level-4 placeholder today, the level curve is an open ruling)
--   ep3_etyyy_webweaver_crazed -> webweaver  size=5  iff-matched (repo templates iff equals SOE template column webweaver.iff; creatures.tab line 1329; level-4 placeholder today, the level curve is an open ruling)
