...
--   ep3_etyyy_walluga -> walluga  size=6  iff-matched (repo templates iff equals SOE template column walluga.iff; creatures.tab line 1324; level-4 placeholder today, the level curve is an open ruling)
--   ep3_etyyy_walluga -> walluga  size=6  iff-matched (repo templates iff equals SOE template column walluga.iff; creatures.tab line 1324; level-4 placeholder today, the level curve is an open ruling)
--   ep3_etyyy_walluga -> walluga  size=6  iff-matched (repo templates iff equals SOE template column walluga.iff; creatures.tab line 1324; level-4 placeholder today, the level curve is an open ruling)
--   ep3_etyyy_walluga -> walluga  size=6  iff-matched (repo templates iff equals SOE template column walluga.iff; creatures.tab line 1324; level-4 placeholder today, the level curve is an open ruling)
