...
--   rebel_commando -> rebel_commando  size=4  exact-name (exact registered name (SOE creatureName equals repo addCreatureTemplate name; lua faction/rebel/rebel_commando.lua; creatures.tab line n/a))
--   rebel_commando -> rebel_commando  size=4  exact-name (exact registered name (SOE creatureName equals repo addCreatureTemplate name; lua faction/rebel/rebel_commando.lua; creatures.tab line n/a))
--   rebel_commando -> rebel_commando  size=4  exact-name (exact registered name (SOE creatureName equals repo addCreatureTemplate name; lua faction/rebel/rebel_commando.lua; creatures.tab line n/a))
