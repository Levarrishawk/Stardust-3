...
--   ep3_forest_exemplar_zheus -> dressed_ep3_forest_outcast_assassin_01  size=1  set-matched (SOE template column = ep3_forest_outcast_assassin; repo numbered members; C6 creatures.tab line 1345)
