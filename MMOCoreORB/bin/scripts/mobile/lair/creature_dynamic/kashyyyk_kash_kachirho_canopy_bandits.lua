...
--   ep3_kachirho_canopy_bandit  size=1  OPEN (no creature-table match; not guessed)
--   ep3_kachirho_canopy_bandit  size=1  OPEN (no creature-table match; not guessed)
--   ep3_kachirho_canopy_bandit  size=1  OPEN (no creature-table match; not guessed)
--   ep3_kachirho_canopy_bandit  size=1  OPEN (no creature-table match; not guessed)
--   ep3_kachirho_canopy_bandit  size=1  OPEN (no creature-table match; not guessed)
--   ep3_kachirho_canopy_bandit  size=1  OPEN (no creature-table match; not guessed)
--   ep3_kachirho_canopy_cutthroat  size=1  OPEN (no creature-table match; not guessed)
--   ep3_kachirho_canopy_cutthroat  size=1  OPEN (no creature-table match; not guessed)
--   ep3_kachirho_canopy_cutthroat  size=1  OPEN (no creature-table match; not guessed)
