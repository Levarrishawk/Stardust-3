...
--   ep3_rryatt_walluga_smasher -> walluga  size=6  iff-matched (repo templates iff equals SOE template column walluga.iff; C6 unmatched_rows (C6 scout skipped custom_content/mobile/); level-4 placeholder today, C6 revisits levels; C6 creatures.tab line 1548; lua walluga.lua)
--   ep3_rryatt_walluga_smasher -> walluga  size=6  iff-matched (repo templates iff equals SOE template column walluga.iff; C6 unmatched_rows (C6 scout skipped custom_content/mobile/); level-4 placeholder today, C6 revisits levels; C6 creatures.tab line 1548; lua walluga.lua)
