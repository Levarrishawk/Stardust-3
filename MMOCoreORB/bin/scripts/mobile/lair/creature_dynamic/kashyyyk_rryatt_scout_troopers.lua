...
--   scout_trooper -> scout_trooper  size=4  exact-name (exact registered name (SOE creatureName equals repo addCreatureTemplate name; lua faction/imperial/scout_trooper.lua; creatures.tab line n/a))
--   scout_trooper -> scout_trooper  size=4  exact-name (exact registered name (SOE creatureName equals repo addCreatureTemplate name; lua faction/imperial/scout_trooper.lua; creatures.tab line n/a))
--   scout_trooper -> scout_trooper  size=4  exact-name (exact registered name (SOE creatureName equals repo addCreatureTemplate name; lua faction/imperial/scout_trooper.lua; creatures.tab line n/a))
