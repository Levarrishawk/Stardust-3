...
--   ep3_fern_bicker -> ep3_fern_bicker  size=4  iff-matched (repo templates iff equals SOE template column ep3_fern_bicker.iff; C6 creatures.tab line 1336; C6 scout skipped custom_content/mobile/; level-4 placeholder today, C6 revisits levels)
