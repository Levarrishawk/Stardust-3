...
-- rotate numbered variants row by row. OPEN commando/battleleader unchanged.
-- Creature rows (SOE creatureName -> repo template):
--   ep3_npc_wookiee_commando  size=1  OPEN (no mapping and no the creature table numbered-variant rotation; not guessed)
--   ep3_npc_wookiee_commando  size=1  OPEN (no mapping and no the creature table numbered-variant rotation; not guessed)
...
--   ep3_npc_wookiee_battleleader  size=1  OPEN (no mapping and no the creature table numbered-variant rotation; not guessed)
