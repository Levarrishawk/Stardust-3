...
--   ep3_npc_rodian_eharttclan -> ep3_etyyy_hunter_eharttclan_01  size=2  set-matched (SOE template column = etyyy_rodian_eharttclan; repo numbered members; C6 creatures.tab line 1468)
