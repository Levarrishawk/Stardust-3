...
--   ep3_kklyyytt -> ep3_kklyyytt  size=4  iff-matched (repo templates iff equals SOE template column; level-4 placeholder today, the level curve is an open ruling)
