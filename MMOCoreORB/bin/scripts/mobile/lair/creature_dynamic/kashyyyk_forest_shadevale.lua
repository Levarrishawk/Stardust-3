...
--   ep3_forest_shadevale_stalker -> crystal_snake  size=2  iff-matched (SOE template column crystal_snake.iff = mobile/yavin4/crystal_snake.lua templates; creatures.tab line 1365)
--   ep3_forest_shadevale_venomsting -> fanned_rawl  size=2  iff-matched (SOE template column fanned_rawl.iff = mobile/naboo/fanned_rawl.lua templates (hue variant); creatures.tab line 1366)
