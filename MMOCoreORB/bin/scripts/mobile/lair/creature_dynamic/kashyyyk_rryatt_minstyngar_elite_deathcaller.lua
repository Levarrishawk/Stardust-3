...
--   ep3_rryatt_minstyngar_elite_bloodspiller -> minstyngar  size=6  iff-matched (repo templates iff equals SOE template column minstyngar.iff; C6 unmatched_rows (C6 scout skipped custom_content/mobile/); level-400 as the template stands, C6 revisits levels; C6 creatures.tab line 1526; lua minstyngar.lua)
