-- SOURCED -- datatables/spawning/ground_spawning/types/kashyyyk/etyyy_uller_elder.tab
...
--   ep3_etyyy_uller_elder -> uller_stoneclaw  size=4  c6-match (C6 creatures.tab line 1321; lua uller_stoneclaw.lua)
--   ep3_etyyy_uller_elder -> uller_stoneclaw  size=4  c6-match (C6 creatures.tab line 1321; lua uller_stoneclaw.lua)
kashyyyk_etyyy_uller_elder = Lair:new {
...
addLairTemplate("kashyyyk_etyyy_uller_elder", kashyyyk_etyyy_uller_elder)
