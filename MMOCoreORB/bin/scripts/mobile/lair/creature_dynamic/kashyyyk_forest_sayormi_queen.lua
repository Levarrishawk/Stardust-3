...
--   ep3_forest_sayormi_queen -> dressed_sayormi_queen  size=1  iff-matched (repo templates iff equals SOE template column dressed_sayormi_queen.iff; C6 creatures.tab line 1362; C6 scout skipped custom_content/mobile/; level-4 placeholder today, C6 revisits levels))
