...
--   ep3_rryatt_abandoned_battle_droid -> ep3_rryatt_abandoned_battle_droid_02  size=6  set-matched (C6 creatures.tab line 1506; C6 unmatched_rows (set name rryatt_battle_droid; numbered members ep3_rryatt_abandoned_battle_droid_01.._03))
--   ep3_rryatt_abandoned_battle_droid -> ep3_rryatt_abandoned_battle_droid_03  size=6  set-matched (C6 creatures.tab line 1506; C6 unmatched_rows (set name rryatt_battle_droid; numbered members ep3_rryatt_abandoned_battle_droid_01.._03))
--   ep3_rryatt_abandoned_battle_droid -> ep3_rryatt_abandoned_battle_droid_01  size=6  set-matched (C6 creatures.tab line 1506; C6 unmatched_rows (set name rryatt_battle_droid; numbered members ep3_rryatt_abandoned_battle_droid_01.._03))
--   ep3_rryatt_abandoned_battle_droid -> ep3_rryatt_abandoned_battle_droid_02  size=6  set-matched (C6 creatures.tab line 1506; C6 unmatched_rows (set name rryatt_battle_droid; numbered members ep3_rryatt_abandoned_battle_droid_01.._03))
