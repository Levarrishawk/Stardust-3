...
--   ep3_etyyy_webweaver_silkthrower -> webweaver  size=5  iff-matched (repo templates iff equals SOE template column webweaver.iff; C6 creatures.tab line 1330; C6 scout skipped custom_content/mobile/; level-4 placeholder today, C6 revisits levels)
