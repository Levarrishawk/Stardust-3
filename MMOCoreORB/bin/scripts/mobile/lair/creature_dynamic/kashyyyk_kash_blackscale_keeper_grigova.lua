...
--   ep3_slaver_keeper_grigova -> ep3_keeper_grigova  size=1  iff-matched (repo templates iff equals SOE template column ep3/ep3_keeper_grigova.iff; C6 creatures.tab line 1571; lua ep3_keeper_grigova.lua)
