...
--   ep3_kachirho_bolotaur_fleshripper -> bolotaur  size=1  iff-matched (SOE iff bolotaur.iff (same as ep3_kachirho_bolotaur); level-4 placeholder today, the level curve is an open ruling)
--   ep3_kachirho_bolotaur_fleshripper -> bolotaur  size=1  iff-matched (SOE iff bolotaur.iff (same as ep3_kachirho_bolotaur); level-4 placeholder today, the level curve is an open ruling)
--   ep3_kachirho_bolotaur_fleshripper -> bolotaur  size=1  iff-matched (SOE iff bolotaur.iff (same as ep3_kachirho_bolotaur); level-4 placeholder today, the level curve is an open ruling)
--   ep3_kachirho_bolotaur -> bolotaur  size=1  iff-matched (SOE iff bolotaur.iff; level-4 placeholder today, the level curve is an open ruling)
--   ep3_kachirho_bolotaur -> bolotaur  size=1  iff-matched (SOE iff bolotaur.iff; level-4 placeholder today, the level curve is an open ruling)
--   ep3_kachirho_sunbaked  size=1  OPEN (no repo template (ruling 2026-09-04 still OPEN))
