-- SOURCED -- datatables/spawning/ground_spawning/types/kashyyyk/kash_kachiro_sieged_trandos.tab
...
kashyyyk_kash_kachiro_sieged_trandos = Lair:new {
	mobiles = {{"ep3_trando_slaver",1}},
	spawnLimit = 2,
	buildingsVeryEasy = {},
  buildingsEasy = {},
  buildingsMedium = {},
...
addLairTemplate("kashyyyk_kash_kachiro_sieged_trandos", kashyyyk_kash_kachiro_sieged_trandos)
