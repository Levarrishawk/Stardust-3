...
--   ep3_kachirho_varactyl_preystalker -> varactyl_preystalker  size=4  (creatures.tab line 1411; lua varactyl_preystalker.lua) [picked 1 of 4 the creature table lua matches]
--   ep3_kachirho_varactyl_preystalker -> varactyl_preystalker  size=4  (creatures.tab line 1411; lua varactyl_preystalker.lua) [picked 1 of 4 the creature table lua matches]
--   ep3_kachirho_varactyl_deathspine -> varactyl_deathspine  size=4  (creatures.tab line 1409; lua varactyl_deathspine.lua) [picked 1 of 4 the creature table lua matches]
