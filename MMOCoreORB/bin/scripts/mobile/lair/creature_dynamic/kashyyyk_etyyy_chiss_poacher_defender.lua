...
--   ep3_etyyy_chiss_poacher_defender -> ep3_etyyy_chiss_poacher_defender_02  size=2  set-rotate (creatures.tab line 1290; rotate numbered variants (4 the creature table lua matches))
--   ep3_etyyy_chiss_poacher_defender -> ep3_etyyy_chiss_poacher_defender_03  size=2  set-rotate (creatures.tab line 1290; rotate numbered variants (4 the creature table lua matches))
