...
--   ep3_rryatt_walluga_smasher_boss -> walluga  size=6  iff-matched (repo templates iff equals SOE template column walluga.iff; the creature table unmatched_rows (); level-4 placeholder today, the level curve is an open ruling; creatures.tab line 1549; lua walluga.lua)
