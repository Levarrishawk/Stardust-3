-- SOURCED (ruling 2026-09-04): socialGroup/faction from datatables/mob/creatures.tab line 1301 (ep3_etyyy_kerssoc, where=kashyyyk, NORMAL).
...
ep3_etyyy_kerssoc = Creature:new {
	...
	lootGroups = {},
	weapons = {},
	conversationTemplate = "ep3_etyyy_kerssoc_convotemplate",
