-- SOURCED (ruling 2026-09-04): socialGroup/faction from datatables/mob/creatures.tab line 1419 (ep3_lesnorr, where=kashyyyk, NORMAL).
...
ep3_lesnorr = Creature:new {
	...
	lootGroups = {},
	weapons = {},
	conversationTemplate = "ep3_lesnorr_convotemplate",
