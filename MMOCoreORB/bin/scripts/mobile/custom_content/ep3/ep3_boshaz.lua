-- SOURCED (ruling 2026-09-04): socialGroup/faction from datatables/mob/creatures.tab line 1256 (ep3_boshaz, where=kashyyyk, NORMAL).
...
ep3_boshaz = Creature:new {
	...
	lootGroups = {},
	weapons = {},
	conversationTemplate = "ep3_boshaz_convotemplate",
