-- Volcano Battlefield HK-47 finale risen add, a Risen Sustainer revived from a corpse.
-- Live row som_volcano_final_risen_sustainer, level 80 ELITE; level here is BOSS tier 120, not live's 80 -- see
-- the note below.
-- Live weapon droid_hk77_elite.iff is unregistered, so this falls back to ranged_weapons from hk77.lua;
-- live's boss/elite/assault HK-77 distinction collapses to the same group. Live scale 1.3 is dropped
...
-- from live.
som_volcano_final_risen_sustainer = Creature:new {
	customName = "a Risen Sustainer",
...
CreatureTemplates:addCreatureTemplate(som_volcano_final_risen_sustainer, "som_volcano_final_risen_sustainer")
