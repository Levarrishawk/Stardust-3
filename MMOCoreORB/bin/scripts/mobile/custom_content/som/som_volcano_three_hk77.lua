-- Volcano Battlefield event_three guard, an HK-77 Assault Droid (also used as the staged corpse).
-- Live row som_volcano_three_hk77, level 80 ELITE; level here is BOSS tier 120, not live's 80 -- see
-- the note below.
...
-- from live.
som_volcano_three_hk77 = Creature:new {
...
CreatureTemplates:addCreatureTemplate(som_volcano_three_hk77, "som_volcano_three_hk77")
