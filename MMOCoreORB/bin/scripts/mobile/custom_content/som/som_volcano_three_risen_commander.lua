-- Volcano Battlefield event_three risen add, a Risen Commander revived from a staged corpse.
-- Live row som_volcano_three_risen_commander, level 82 ELITE; level here is BOSS tier 120, not live's 82 -- see
-- the note below.
-- Live weapon droid_hk77_elite.iff is unregistered, so this falls back to ranged_weapons from hk77.lua;
-- live's boss/elite/assault HK-77 distinction collapses to the same group. Live scale 1.4 is dropped
-- because Core3 Creature templates have no scale field.
...
-- from live.
som_volcano_three_risen_commander = Creature:new {
	customName = "a Risen Commander",
...
CreatureTemplates:addCreatureTemplate(som_volcano_three_risen_commander, "som_volcano_three_risen_commander")
