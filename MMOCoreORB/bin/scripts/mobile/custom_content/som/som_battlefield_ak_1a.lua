-- Valley Battlefield (mustafar_droid_army) AK-1A assault killer. Live row
-- som_battlefield_ak_1a, level 82 BOSS; level here is NAMED tier 100 from
...
-- cww8_battle_droid.lua -- live's droid_cww8_01 is unregistered. customName
-- is authored because no .stf ships in the extract.
som_battlefield_ak_1a = Creature:new {
	customName = "an AK-1A Assault Killer Bot",
...
CreatureTemplates:addCreatureTemplate(som_battlefield_ak_1a, "som_battlefield_ak_1a")
