--[[ som_orf_beetle_worker -- Old Republic Facility beetle.
...
som_orf_beetle_worker = Creature:new {
	customName = "an ORF worker beetle",
...
CreatureTemplates:addCreatureTemplate(som_orf_beetle_worker, "som_orf_beetle_worker")