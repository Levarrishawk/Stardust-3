-- Volcano Battlefield HK-47 finale squad member (also used as staged revive corpses).
-- Live row som_volcano_final_squadmember, level 80 ELITE; level here is BOSS tier 120, not live's 80 -- see
-- the note below.
...
-- from live.
som_volcano_final_squadmember = Creature:new {
...
CreatureTemplates:addCreatureTemplate(som_volcano_final_squadmember, "som_volcano_final_squadmember")
