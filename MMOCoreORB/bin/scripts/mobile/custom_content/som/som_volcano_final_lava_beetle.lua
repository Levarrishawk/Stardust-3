-- Volcano Battlefield HK-47 finale add, a lava beetle summoned at the 80% HP ladder step.
-- Live row som_volcano_final_lava_beetle, level 80 ELITE; level here is BOSS tier 120, not live's 80 -- see
-- the note below.
...
-- from live.
som_volcano_final_lava_beetle = Creature:new {
...
CreatureTemplates:addCreatureTemplate(som_volcano_final_lava_beetle, "som_volcano_final_lava_beetle")
