--[[ som_orf_flea_juvenile -- Old Republic Facility flea.
     ...
     set to 0 -- dungeon spawn, not a tameable pet. scale 0.4 is retail
     minScale=maxScale (life-stage split). mobType/diet CARNIVORE to match
     retail niche=carnivore. ]]
som_orf_flea_juvenile = Creature:new {
	customName = "a juvenile ORF flea",
...
CreatureTemplates:addCreatureTemplate(som_orf_flea_juvenile, "som_orf_flea_juvenile")