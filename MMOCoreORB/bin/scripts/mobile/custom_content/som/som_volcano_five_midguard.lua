-- Volcano Battlefield event_five midguard wall, a GK Midguard under the Oppressor.
-- Live row som_volcano_five_midguard, level 83 ELITE; level here is BOSS tier 120, not live's 83 -- see
-- the note below.
-- Live weapon droid_union_sentry_01.iff is unregistered, so this falls back to the defaultWeapon /
-- defaultAttack shape and loot block from union_sentry_droid.lua. Live scale 0.9 is dropped because
-- Core3 Creature templates have no scale field.
...
-- from live.
som_volcano_five_midguard = Creature:new {
	customName = "a GK Midguard",
...
CreatureTemplates:addCreatureTemplate(som_volcano_five_midguard, "som_volcano_five_midguard")
