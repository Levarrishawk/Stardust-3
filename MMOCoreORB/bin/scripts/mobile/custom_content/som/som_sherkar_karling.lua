--[[ som_sherkar_karling -- Karling, one of four guards monster_manager.java
     places in the Monster Lair. Live record: creatures.tab BaseLevel 83 /
     difficultyClass ELITE / HP 65400 (runtime from trial.java, header only --
     Core3 has no matching HAM column; the tier ladder's baseHAM governs) /
     where mustafar / socialGroup sherkar / template som/sher_kar.iff /
     minScale 0.13 / maxScale 0.13 / hue 1 / intLootRolls 1 / intRollPercent 80 /
     lootTable BLANK / niche carnivore / meat 16 meat_insect /
     hide 24 hide_scaley / primary_weapon blank / primary_weapon_specials
     spider_5 / aggressive 6 / assist 6 / death_blow instant /
     script sher_kar.karling.

     TIER: ELITE 85. Live level 83 / difficultyClass ELITE maps to the ELITE 85
     ...
     SOURCED:
       customName "Karling" -- live English name.
       socialGroup "sherkar" -- live.
       templates {"object/mobile/som/sher_kar.iff"}, hues { 1 }, scale 0.13 --
         live. Same sher_kar.iff body as the boss (scale 1.2); at 0.13 it reads
...
som_sherkar_karling = Creature:new {
	customName = "Karling",
	socialGroup = "sherkar",
	faction = "",
...
CreatureTemplates:addCreatureTemplate(som_sherkar_karling, "som_sherkar_karling")
