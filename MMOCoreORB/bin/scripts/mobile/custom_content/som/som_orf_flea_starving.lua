--[[ som_orf_flea_starving -- Old Republic Facility flea.
     ...
     set to 0 -- dungeon spawn, not a tameable pet. scale 0.5 is retail
     minScale=maxScale (life-stage split). mobType/diet CARNIVORE to match
     retail niche=carnivore. ]]
som_orf_flea_starving = Creature:new {
	customName = "a starving ORF flea",
...
CreatureTemplates:addCreatureTemplate(som_orf_flea_starving, "som_orf_flea_starving")