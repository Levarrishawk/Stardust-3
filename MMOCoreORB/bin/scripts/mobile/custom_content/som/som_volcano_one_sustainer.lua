-- Volcano Battlefield event_one guard, the Droid Army Sustainer that heals the taskmaster.
-- Live row som_volcano_one_sustainer, level 83 ELITE; level here is BOSS tier 120, not live's 83 -- see
-- the note below.
...
-- from live.
som_volcano_one_sustainer = Creature:new {
	customName = "a Droid Army Sustainer",
...
CreatureTemplates:addCreatureTemplate(som_volcano_one_sustainer, "som_volcano_one_sustainer")
