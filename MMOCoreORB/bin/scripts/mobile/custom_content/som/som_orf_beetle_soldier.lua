--[[ som_orf_beetle_soldier -- Old Republic Facility beetle.
...
som_orf_beetle_soldier = Creature:new {
	customName = "an ORF soldier beetle",
...
CreatureTemplates:addCreatureTemplate(som_orf_beetle_soldier, "som_orf_beetle_soldier")