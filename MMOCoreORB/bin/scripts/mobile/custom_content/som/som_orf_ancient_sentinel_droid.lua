--[[ som_orf_ancient_sentinel_droid -- Old Republic Facility sentinel droid.
     Retail creatures.tab: BaseLevel 86, difficultyClass NORMAL,
     ...
     Retail BaseLevel 86 is recorded here and NOT copied into level.
     Copied from cww8_battle_droid.lua; appearance cww8a_battle_droid.iff;
     diet = NONE; scale 0.8 from retail. ]]
som_orf_ancient_sentinel_droid = Creature:new {
	customName = "an Old Republic sentinel droid",
...
CreatureTemplates:addCreatureTemplate(som_orf_ancient_sentinel_droid, "som_orf_ancient_sentinel_droid")