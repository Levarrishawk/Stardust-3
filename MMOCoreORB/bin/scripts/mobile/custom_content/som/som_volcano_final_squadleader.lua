-- Volcano Battlefield HK-47 finale squad leader at the wall.
-- Live row som_volcano_final_squadleader, level 83 ELITE; level here is BOSS tier 120, not live's 83 -- see
-- the note below.
...
-- from live.
som_volcano_final_squadleader = Creature:new {
	customName = "a Droid Army Squad Leader",
...
CreatureTemplates:addCreatureTemplate(som_volcano_final_squadleader, "som_volcano_final_squadleader")
