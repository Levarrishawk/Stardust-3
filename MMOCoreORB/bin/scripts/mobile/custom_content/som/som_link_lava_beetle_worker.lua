--[[ som_link_lava_beetle_worker -- Kubaza Beetle Worker, the minority trash
     beetle the Establish the Link trial's bug_spawner places at each lair.
     ...
     som/kubaza_beetle.iff / minScale 1.1 / maxScale 1.1 / hue 1 / armorStun -1
     ...
     primary_weapon_specials roach_5 / aggressive 0 / assist 6.
     ...
     SOURCED:
       customName "a Kubaza Beetle Worker" -- authored English; matching the
       ...
       creatureBitmask NONE -- live blanks death_blow.
       scale 1.1 and hues { 1 } -- live minScale/maxScale/hue.
...
som_link_lava_beetle_worker = Creature:new {
	customName = "a Kubaza Beetle Worker",
...
CreatureTemplates:addCreatureTemplate(som_link_lava_beetle_worker, "som_link_lava_beetle_worker")
