--[[ som_working_hk_58_besh -- HK-58 Besh, Working Droid Factory trial boss.
     ...
     Byte-identical to som_working_hk_58_aurek in creatures.tab apart from the
     ...
     SOURCED:
       customName "HK-58 Besh" -- live English name.
...
som_working_hk_58_besh = Creature:new {
...
CreatureTemplates:addCreatureTemplate(som_working_hk_58_besh, "som_working_hk_58_besh")
