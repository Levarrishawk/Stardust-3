-- heroic_echo_rebel_turret_s1 -- Echo Base heroic Rebel turret (sector 1).
--
-- SOURCED (SOE, creatures.tab:6168): creatureName heroic_echo_rebel_turret_s1,
...
heroic_echo_rebel_turret_s1 = Creature:new {
...
CreatureTemplates:addCreatureTemplate(heroic_echo_rebel_turret_s1, "heroic_echo_rebel_turret_s1")
