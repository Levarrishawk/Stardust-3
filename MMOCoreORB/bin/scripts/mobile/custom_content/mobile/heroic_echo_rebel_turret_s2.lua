-- heroic_echo_rebel_turret_s2 -- Echo Base heroic Rebel turret (sector 2).
--
-- SOURCED (SOE, creatures.tab:6169): creatureName heroic_echo_rebel_turret_s2,
-- BaseLevel 90, difficultyClass ELITE, socialGroup rebel, faction Rebel,
-- template hoth_turret_s2.iff, minScale 1.5, maxScale 1.5, niche vehicle,
...
--
-- Appearance: object/mobile/hoth_turret_s2.iff (registered in
-- object/custom_content/mobile/hoth_turret_s2.lua:5).
--
...
heroic_echo_rebel_turret_s2 = Creature:new {
...
CreatureTemplates:addCreatureTemplate(heroic_echo_rebel_turret_s2, "heroic_echo_rebel_turret_s2")
