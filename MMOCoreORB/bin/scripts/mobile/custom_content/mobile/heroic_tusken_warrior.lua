-- heroic_tusken_warrior -- Mos Espa heroic trash.
--
-- SOURCED (SOE, creatures.tab:2200): creatureName heroic_tusken_warrior, BaseLevel 90,
...
heroic_tusken_warrior = Creature:new {
...
CreatureTemplates:addCreatureTemplate(heroic_tusken_warrior, "heroic_tusken_warrior")
