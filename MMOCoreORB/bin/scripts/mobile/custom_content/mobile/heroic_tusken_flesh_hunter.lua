-- heroic_tusken_flesh_hunter -- Mos Espa heroic trash.
--
-- SOURCED (SOE, creatures.tab:2178): creatureName heroic_tusken_flesh_hunter, BaseLevel 90,
...
-- 18 spawned; the rescue-house assault pairs.
--
...
heroic_tusken_flesh_hunter = Creature:new {
	customName = "a Tusken flesh hunter",
...
CreatureTemplates:addCreatureTemplate(heroic_tusken_flesh_hunter, "heroic_tusken_flesh_hunter")
