-- heroic_tusken_raider -- Mos Espa heroic trash.
--
-- SOURCED (SOE, creatures.tab:2195): creatureName heroic_tusken_raider, BaseLevel 90,
...
heroic_tusken_raider = Creature:new {
	customName = "a Tusken raider",
...
CreatureTemplates:addCreatureTemplate(heroic_tusken_raider, "heroic_tusken_raider")
