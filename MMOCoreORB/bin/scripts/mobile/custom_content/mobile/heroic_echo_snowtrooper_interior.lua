-- heroic_echo_snowtrooper_interior -- Echo Base heroic Imperial snowtrooper (interior).
--
-- SOURCED (SOE, creatures.tab:6155): creatureName heroic_echo_snowtrooper_interior,
...
heroic_echo_snowtrooper_interior = Creature:new {
	...
	-- SOURCED (creatures.tab:6155 lootTable); EB-f
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(heroic_echo_snowtrooper_interior, "heroic_echo_snowtrooper_interior")
