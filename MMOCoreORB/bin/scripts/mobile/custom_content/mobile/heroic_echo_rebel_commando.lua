-- heroic_echo_rebel_commando -- Echo Base heroic Rebel commando.
--
-- SOURCED (SOE, creatures.tab:6163): creatureName heroic_echo_rebel_commando,
...
--
-- SOE AI-profile specials (heroic_echo_rebel_commando) not ported, no Core3 command.
-- Never weapons/attacks -- CreatureTemplate::readObject() does not read them.
heroic_echo_rebel_commando = Creature:new {
	customName = "a Rebel commando",
	socialGroup = "rebel",
	faction = "rebel",
	mobType = MOB_NPC,
	level = 85,
...
CreatureTemplates:addCreatureTemplate(heroic_echo_rebel_commando, "heroic_echo_rebel_commando")
