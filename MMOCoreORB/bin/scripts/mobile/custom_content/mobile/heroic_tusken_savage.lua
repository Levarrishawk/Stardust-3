-- heroic_tusken_savage -- Mos Espa heroic trash.
--
-- SOURCED (SOE, creatures.tab:2196): creatureName heroic_tusken_savage, BaseLevel 90,
...
heroic_tusken_savage = Creature:new {
	customName = "a Tusken savage",
...
CreatureTemplates:addCreatureTemplate(heroic_tusken_savage, "heroic_tusken_savage")
