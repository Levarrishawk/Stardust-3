owen_lars_outfit = {
  {
    ...
    {objectTemplate = "object/tangible/wearables/robe/robe_s05.iff", customizationVariables = {{"/private/index_color_1", 97}} },
...
addOutfitGroup("owen_lars_outfit", owen_lars_outfit)