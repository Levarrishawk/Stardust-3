...
includeFile("outfits/bail_organa_outfit.lua")
...
includeFile("outfits/owen_lars_outfit.lua")
includeFile("outfits/isb_outfit.lua")
includeFile("outfits/inquisitor_outfit.lua")
