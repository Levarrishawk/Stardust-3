aqzow_liaison = Creature:new {
	objectName = "Havoc Squadron Liaison",
	...
	conversationTemplate = "aqzow_liaison_convo",
	primaryAttacks = {},
	secondaryAttacks = {}
}

CreatureTemplates:addCreatureTemplate(aqzow_liaison, "aqzow_liaison")
