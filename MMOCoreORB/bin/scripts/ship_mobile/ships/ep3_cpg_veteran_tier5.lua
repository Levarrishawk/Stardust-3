...
ep3_cpg_veteran_tier5 = ShipAgent:new {
	...
	conversationMobile = "object/mobile/shared_space_comm_ep3_cpg_veteran_02.iff",
	conversationMessage = "@conversation/ep3_cpg_veteran:s_185", --Too Far Message: What? You're breaking up!
}

ShipAgentTemplates:addShipAgentTemplate(ep3_cpg_veteran_tier5, "ep3_cpg_veteran_tier5")
